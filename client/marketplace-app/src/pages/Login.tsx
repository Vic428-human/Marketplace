...
const SlidingLoginSignup = () => {
  ...
  return (
    <div className="">
      ...
      <div
        className="absolute w-full h-full top-0 left-0 grid grid-cols-1 lg:grid-cols-2 
      "
      >
        ...
        >
          <div
            className={`flex flex-col items-center text-white transition-transform duration-[0.9s]  lg:duration-[1.1s] ease-[ease-in-out] 
          ...
          >
            <h3 className="lg:block font-semibold leading-none text-[1.2rem] lg:text-[1.5rem] text-gray-700">
              第一次來?
            </h3>
            ...
            <div
              // type="button"
              className="w-[200px] text-white bg-backgroundColor hover:bg-brightColor focus:ring-4 focus:outline-none
              focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-3 text-center transition-all
              duration-200 transform hover:scale-[1.02] hover:shadow-md"
        ...
        <div
          className={`flex flex-row justify-around lg:flex-col items-center max-lg:col-start-1 max-lg:col-end-2
         max-lg:px-[8%] max-lg:py-10 lg:items-end text-center z-6 max-lg:row-start-3 max-lg:row-end-4
           pl-[17%] pr-[12%] pt-12 pb-8 ${
             isSignUpMode ? " pointer-events-auto" : "pointer-events-none"
           }`}
        >
          <div
            className={`flex flex-col items-center text-white transition-transform duration-[0.9s] lg:duration-[1.1s] ease-in-out delay-[0.8s]
      ...
      {/* 2. 登入註冊面板區域 */}
      <div className="absolute w-full lg:h-full top-0 left-0">
        ...
        >
          ...
          <div
            className={`flex items-center justify-center flex-col transition-all duration-[0.02s] delay-[0.2s] 
              ...
              max-md:py-0 ${isSignUpMode ? "hidden" : "opacity-100 z-20"}`}
          >
            <SignInForm
          ...
          <div
            className={`flex items-center justify-center flex-col px-20 transition-all ease-in-out duration-[0.2s]
               ...
               max-md:py-0 opacity-0 ${
                 isSignUpMode ? "opacity-100 z-20 " : "hidden"
               }`}
          >
            <SignUpForm
              buttonClasses={buttonClasses}
